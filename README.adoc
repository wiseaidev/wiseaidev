...
I'm currently locked in with the boys, building Kevin RS and Open SASS (formerly known as link:https://github.com/next-rs[Next RS]). I realized I could make the components framework-agnostic. I would be forever grateful if you could help me with its development:

[cols="2"]

|===

| link:https://github.com/opensass/eld[image:https://github-readme-stats.vercel.app/api/pin/?username=opensass&repo=eld&show_icons=true&theme=dark[🚛 ELD Toolkit for WASM frameworks, width=450]]

| link:https://github.com/opensass/eldflow[image:https://github-readme-stats.vercel.app/api/pin/?username=opensass&repo=eldflow&show_icons=true&theme=dark[🚛 Darn Easy ELD Log Management & Smart Trip Planning 🛣️, width=450]]
...
=== You can support my ongoing FOSS work by buying a copy of these books:
...
==== I used to code in C#, Python, and (Java/Type)Script in a past life, but I've moved on; Those are just kids/code-vibers' toys now!
...
> 📝 Silly Pun: The "AI" in my username "wiseaidev" stands for *Anonymous Individual* (like *Anonymous Indian*), not *Artificial Intelligence*.
